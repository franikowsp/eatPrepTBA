...
The goal of eatPrepTBA is provide wrapper functions to interact with the IQB Studio and the IQB Testcenter APIs. Moreover, provides some routines for preparing and blending data from these different resources.
